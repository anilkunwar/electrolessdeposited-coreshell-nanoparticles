    ...
    if st.session_state.temporal_manager:
        ...
        with tabs[6]:
            ...
            if not st.session_state.solutions:
                ...
                if abs(target_L0 - gt_L0) > 1.0:
                    st.warning(f"Domain size mismatch: target L0 = {target_L0} nm, ground truth L0 = {gt_L0} nm. "
                               f"Comparison may be affected because physical scales differ.")
                    ...
                    for field_title, (field_key, cmap_choice) in compare_fields.items():
                        ...
                        with col_plot1:
                            ...
                            fig_gt = st.session_state.visualizer.create_field_heatmap(
                                ...
                                L0_nm=gt_params.get('L0_nm', 20.0),  # use ground truth L0 for axes
                        ...
                        with col_plot2:
                            ...
                            fig_interp = st.session_state.visualizer.create_field_heatmap(
                                ...
                                cmap_name=cmap_choice, 
                                L0_nm=target.get('L0_nm', 20.0),   # use target L0 for axes
                                target_params=target,
                                time_real_s=current_time_real
                            )
                        ...
                        with col_plot3:
                            ...
                            fig_diff = st.session_state.visualizer.create_field_heatmap(
                                diff, "Difference", 
                                cmap_name='RdBu_r', 
                                L0_nm=gt_params.get('L0_nm', 20.0),  # use ground truth L0 for axes (common)
                                colorbar_label="Δ",
