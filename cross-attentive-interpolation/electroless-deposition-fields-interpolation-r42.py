...
class CompletionAnalyzer:
    ...
    # NEW: Improved LLM completeness inference with robust JSON extraction
    @staticmethod
    def llm_infer_completeness(desc: str, tokenizer, model) -> Tuple[bool, Optional[float], Optional[float], str]:
        ...
        user = f"""Analyze this shell formation data and decide if the Ag shell is complete.
Data:
{desc}
...
{{
  "complete": true/false,
  "t_complete": float or null,
  "dr_min": float or null,
            ...
            if match:
                ...
                if 'complete' in generated.lower():
                    if 'true' in generated.lower() or 'yes' in generated.lower():
                        return True, None, None, "LLM: Inferred complete (keyword)"
                    else:
                        return False, None, None, "LLM: Inferred incomplete (keyword)"
