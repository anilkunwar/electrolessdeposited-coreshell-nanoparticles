...
if len(st.session_state.history) > 1:
    ...
    # (unchanged styling sliders etc.)

    # ... (the whole batch comparison block exactly as in your original code) ...
...
if st.session_state.history:
    ...
    # ... rest of playback (frame slider, plots, material proxy, VTU, GIF, PNG, etc.) exactly as original ...
