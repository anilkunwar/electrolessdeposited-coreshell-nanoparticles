...
- **L0-GATED WEIGHTING**: Enforces scale-awareness by down-weighting sources with mismatched domain sizes
...
# =============================================
# L0 GATED MASK IMPLEMENTATION
# =============================================
# Enforce scale-awareness by down-weighting sources with mismatched domain sizes.
# This addresses the physical reality that fc=0.18 behaves differently at L0=20nm vs L0=60nm.
gate_factors = []
...
gate = 0.40  # Interpolated gap fill
elif delta_L0 < 25:
gate = 0.20
else:
gate = 0.05
