...
=============================================================
- Natural language interface (regex‑based)
...
class CompletionAnalyzer:
    ...
    def generate_recommendations(params: dict, relevance: float, 
                                  ...
                                  is_complete: bool,
                                  shell_quality: Optional[Dict] = None) -> List[str]:
        suggestions = []
        if relevance < 0.5:
            suggestions.append(
        ...
        # Add shell quality suggestions (NEW)
        if shell_quality:
...
def render_intelligent_designer_tab():
    ...
    if run_design and user_input:
        ...
        recommendations = analyzer.generate_recommendations(
            target_design, relevance, t_complete, dr_min, is_complete, shell_quality
        )
