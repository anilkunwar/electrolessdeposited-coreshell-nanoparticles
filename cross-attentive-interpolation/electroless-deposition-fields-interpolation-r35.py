...
def render_intelligent_designer_tab():
    ...
    if run_design and user_input:
        ...
        # --- FIX: guard against empty key_frames ---
        if not design_manager.key_frames:
            st.error("❌ No material structure key frames could be generated. "
                     "This may be due to incompatible source data or interpolation failure. "
                     "Please check the loaded solutions and target parameters.")
        else:
            ...
            if fields_sel:
                ...
                st.warning("No field data available for the selected time point.")
    ...
    with tabs[2]:
        ...
        if mgr is None:
            ...
            fig_th = st.session_state.visualizer.create_thickness_plot(
                thickness_time,
                title="Shell Thickness Evolution",
                current_time_norm=st.session_state.current_time,
                ...
                with st.spinner("Computing interpolation at ground truth parameters..."):
                    ...
                    if interp_res:
                        ...
                        for field_title, (field_key, cmap_choice) in compare_fields.items():
                            ...
                            if field_key == 'material':
                                interp_data = interp_material   # corrected variable name
                                gt_data = gt_material
                            else:
                            ...
                            if use_physical_alignment:
                                ...
                                interp_L0 = gt_params.get('L0_nm', 20.0)  # using gt_params for interpolation as well
