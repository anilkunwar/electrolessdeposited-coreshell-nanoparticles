...
# -*- coding: utf-8 -*-
"""
Electroless Ag — FULL SINGLE-RUN APP
Features:
...
# ------------------- PAGE -------------------
st.set_page_config(page_title="Electroless Ag — Full Simulator", layout="wide")
st.title("Electroless Ag — Full Single-Run Simulator")
...
gif_button = st.sidebar.button("Generate GIF")
download_png_button = st.sidebar.button("Download PNG Snapshot")
...
if len(st.session_state.history) > 1:
    st.header("Combined Thickness & Norms")
...
if st.session_state.history:
    ...
    # ------------------- GIF -------------------
    if gif_button and GIF_AVAILABLE:
