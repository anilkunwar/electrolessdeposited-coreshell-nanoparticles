...
# ------------------- PAGE -------------------
st.set_page_config(page_title="Electroless Ag — EDL Catalyst", layout="wide")
st.title("Electroless Ag — EDL as Nucleation Catalyst")
...
if len(st.session_state.history) > 1:
    ...
    fig.subplots_adjust(wspace=hspace)  # horizontal spacing
    ...
    if use_edl:
        ...
        fig_decay, ax = plt.subplots(figsize=(figsize_x/2, figsize_y))  # smaller figure
