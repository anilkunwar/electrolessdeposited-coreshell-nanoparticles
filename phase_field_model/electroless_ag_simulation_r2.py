...
# --- 2. Numba Kernels for Laplacian and Gradients ---
...
# --- 3. Fast Simulation Function with caching ---
...
st.markdown("""
**2-D phase-field simulation** accelerated with **Numba JIT** and persistent caching in SQLite.  
Run simulations, visualize results online, and download VTR files for Paraview.
""")
...
if st.sidebar.button("Run Simulation"):
    with st.spinner("Running (Numba)..."):
        run_id = _hash_params(
            ...
            z=1, F=96485, R=8.314, T=298,
            alpha=alpha, i0=i0, c_ref=c_ref,
            M_Ag=0.10787, rho_Ag=10500,
...
if st.session_state.results:
    ...
    if variable.startswith("φ"):
        ...
        # replicate psi at all times for consistency
        data = psi
